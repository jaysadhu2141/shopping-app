...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void didChangeDependencies()
    {
      if (_isInit) {
        ...
        if (productId != "NULL") {
          _editedProduct = Provider.of<Product>(context, listen: false).findById(productId.toString());
  ...
  Future<void> _saveForm() async
  {
      ...
      if (_editedProduct.id == "NULL") {
       await Provider.of<Product>(context, listen: false).updateProduct(_editedProduct.id, _editedProduct);
    ...
    return Scaffold(
      ...
      child: Form(
        ...
        textInputAction: TextInputAction.next,
          ...
          onSaved: (value){
            _editedProduct = Products(id: _editedProduct.id,
